...
│   └── variable_details.csv # Variable value details
├── worksheets/          # Working files for variable harmonization
├── resources/           # Active project resources (e.g., CCHS smoking question trees)
├── references/          # Historical reference materials and legacy code (e.g., SAS code)
├── _quarto.yml          # Quarto site configuration
├── index.qmd            # Main landing page
└── README.md            # Project overview
```

The distinction between folders:
- `resources/`: Contains active reference materials that are regularly consulted during development, such as CCHS question trees, variable mappings, and other supporting documentation that directly informs current work
- `references/`: Contains historical or legacy materials like the original SAS implementation, previous studies, and other background materials that provide context but aren't actively used in day-to-day development
