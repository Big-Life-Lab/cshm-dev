...
subtitle: "Understanding the statistical approach behind CSHGM"
---

# Age-Period-Cohort methodology

This document explains the Age-Period-Cohort (APC) methodology used in the CSHGM.
...
The CSHGM implements APC modeling using:
