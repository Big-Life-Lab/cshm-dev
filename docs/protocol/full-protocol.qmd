...
3.  **Immigration and the PUMF (task 1.9).** The PUMF does not report the year of immigration, so pre-immigration years cannot be excluded in the public-use analysis; state this in section 3.3 and describe the Master-file method.
4.  **Years since quitting in the PUMF (task 1.10).** State how the "3 or more years" group is refined with the finer CCHS variables (2007--2014 and 2015--2022) and how the open-ended "11 or more years" group is treated (section 3.3).
5.  **APC identification (task 1.4b).** Amend section 3.4.3 with the estimable-functions parameterization, the declared allocation of the linear drift, and the validation gate.
6.  **Mortality adjustment (task 1.7b).** Record the estimator and where it enters the calculation (section 3.4.5) once reviewed.
