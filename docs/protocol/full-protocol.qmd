...
version-history:
  - version: "0.4.1"
    date: "2026-08-27"
    description: "Two study decisions recorded (public issue #5): the PUMF initiation-age floor stays at 13 because the 5-11 category is too coarse to date entry, with Master files using exact ages and a floor of 8 (section 3.3); the first CCHS cycle is assigned survey year 2001 for cohort assignment (section 3.2). No change to methods."
  - version: "0.4.0"
    date: "2026-08-07"
