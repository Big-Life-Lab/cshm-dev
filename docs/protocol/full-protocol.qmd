...
2.  **APC intensity model:** We will fit an APC model to estimate the expected CPD by birth cohort. These parameters are the "tobacco dose" input for the simulation stage, allowing for the reconstruction of pack-year histories. For occasional smokers, we will apply a standardized CPD adjustment based on their reported frequency of use.
