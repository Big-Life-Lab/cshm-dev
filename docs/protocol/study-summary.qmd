...
Corresponds to full protocol v0.3.2. This one-page summary is versioned on its own track; see [the full protocol](full-protocol.qmd) for the detailed version history.
