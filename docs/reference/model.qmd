...
This page provides detailed technical documentation for the Age-Period-Cohort (APC) model implementation in the CSHGM package.

## Overview

The APC model is used to separate the effects of age, time period, and birth cohort on smoking initiation and cessation rates. This implementation follows the approach developed by Holford, using natural cubic splines to model these effects.
