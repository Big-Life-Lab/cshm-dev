...
# Canadian Smoking History Generator Model

Welcome to the Canadian Smoking History Generator Model (CSHGM) documentation. This website provides comprehensive information about using and extending the CSHGM for smoking behavior analysis and simulation.

## About CSHGM

The Canadian Smoking History Generator Model is an R implementation of the Age-Period-Cohort (APC) modeling approach to smoking behavior. It builds upon the work of Holford and extends the methodology developed in the Ontario SHGM study (2020).
...
The CSHGM is currently under active development. Contributions, bug reports, and feature requests are welcome through the [GitHub repository](https://github.com/cshgm/cshgm).

## Citation

If you use the CSHGM in your research, please cite:

```
CSHGM Development Team (2024). Canadian Smoking History Generator Model: 
An R implementation of Age-Period-Cohort smoking behavior analysis.
```

## License

The CSHGM is released under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/).
